...
<c:choose>
  <c:when test="${pageType eq 'main'}">
    ...
    <button id="chatbotBtn"
      class="fixed bottom-[130px] right-[30px] z-[1000] bg-white border-none px-5 py-3 rounded-full cursor-pointer
      ...
      <img id="chatbotIcon"
           src="${cpath}/resources/images/chatbot.png"
           alt="챗봇"
           class="w-[30px] h-[30px]" />
    </button>
    ...
    <div id="chatbotModal"
      ...
      <div class="bg-[#A2C8E6] text-[#1f2937] px-4 py-3 font-bold text-[16px] relative">
        챗봇
        <span id="closeChatbot"
    ...
    <script>
      $(function () {
        ...
        function openChatbot() {
          ...
          $('#chatbotIcon').attr('src', '${cpath}/resources/images/close.png')
          .addClass('p-[15px]');
        ...
        function closeChatbot() {
          isOpen = false;
          $('#chatbotModal').hide();
          $('#chatbotIcon').attr('src', '${cpath}/resources/images/chatbot.png')

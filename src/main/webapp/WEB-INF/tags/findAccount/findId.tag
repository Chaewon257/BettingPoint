...
<div class="w-full flex flex-col justify-between p-4">
	<div class="text-bold text-lg mb-4">아이디 찾기</div>
	<div class="w-full pl-2 mb-4">
		<input type="text" id="findName" name="findName" class="w-full px-10 py-4 outline-none bg-gray-4 rounded-full border border-gray-5 mb-2" placeholder="이름" required>
	...
	<button id="findIdSubmit" class="w-full px-10 py-3 outline-none bg-blue-3 rounded-full text-white text-lg hover:bg-blue-1">아이디 찾기</button>
</div>

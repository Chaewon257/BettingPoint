      ...
      <div class="w-full w-[90%] flex flex-col items-center">
        <div class="w-full flex items-end gap-x-4 mb-4">
          <img alt="service image"
               ...
               class="h-40 sm:h-48 md:h-64 lg:h-80">
          <div class="grow mb-8 flex flex-col gap-4">
            ...
            <div class="grid grid-cols-2 md:grid-cols-5 gap-4 text-white font-extrabold text-sm sm:text-base md:text-lg lg:text-xl">
              <button data-tab="free"
                      class="tab-btn bg-blue-3 rounded-lg shadow-[2px_2px_8px_rgba(0,0,0,0.1)] py-2">자유</button>
              <button data-tab="info"
                      class="tab-btn bg-blue-4 hover:bg-blue-3 rounded-lg shadow-[2px_2px_8px_rgba(0,0,0,0.1)] py-2">정보/조언</button>
              <button data-tab="idea"
                      class="tab-btn bg-blue-4 hover:bg-blue-3 rounded-lg shadow-[2px_2px_8px_rgba(0,0,0,0.1)] py-2">제안/아이디어</button>
            </div>
          </div>
        </div>
          ...
          <div class="col-span-4 w-full h-full flex flex-col gap-y-4 bg-gray-8 p-4">
            ...
            <div class="grid grid-cols-8 text-gray-3 font-light text-xs sm:text-sm md:text-base">
              ...
              <div class="flex items-center justify-center gap-x-2">
                <img alt="view image"
                     src="${cpath}/resources/images/view.png"
                     class="w-4">
